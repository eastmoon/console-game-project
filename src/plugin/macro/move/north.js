...
export default class North extends Macro {
    // Constructor
    constructor() {
        super("north");
    ...
    goto($progress = null, $resolve = null) {
        if (typeof $progress.data.direction !== "undefined" && typeof $progress.data.direction.north !== "undefined") {
            const place = $progress.data.direction.north;
